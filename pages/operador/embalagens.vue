  ...
  <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    ...
    <div class="items-center justify-between lg:flex">
      <div class="mb-4 lg:mb-0">
        <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Embalagens de transporte</h3>
      </div>
    </div>
              ...
              <tbody class="bg-white dark:bg-gray-800">
                ...
                <tr v-for="(embalagem, index) in embalagens">
                  ...
                  <td class="p-4 whitespace-nowrap text-center">
                    <NuxtLink :to="`/operador/embalagensCrud/${embalagem.id}`">
...
import NewEmbalagem from '~/pages/operador/embalagensCrud/new-embalagem.vue'
...
const { data: embalagens, error, refresh } = await useFetch(`${api}/embalagensTransporte/`, { headers: { "Authorization": `Bearer ${authStore.token}` } })

const deleteEmbalagem = async (id) => {
  try {
    const response = await useFetch(`${api}/embalagensTransporte/${id}`, {
      method: 'DELETE',
