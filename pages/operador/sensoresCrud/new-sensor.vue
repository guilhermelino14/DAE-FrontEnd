<template>
    <form @submit.prevent="adicionar" class="max-w-sm mx-auto">
        ...
        <div class="mb-5">
            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descricao</label>
        ...
        <button :disable="loading" type="submit"
            ...
            <svg v-show="loading" aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin"
