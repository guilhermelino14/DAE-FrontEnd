            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-semibold dark:text-white">
                        Criar nova embalagem de transporte
                    </h3>
                    <button type="button"
                ...
                <div class="p-6 space-y-6">
                    <form @submit.prevent="adicionar" action="#">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                <label for="altura" class="block text-sm font-medium text-gray-900 dark:text-white"
                                    style="margin-bottom: -15px;">Dimensões</label>
                            </div>
                        ...
                        <!-- Modal footer -->
                        <div class="items-center pt-6 pb-2 border-gray-200 rounded-b dark:border-gray-700"
                            ...
                            <button :disabled="loading" data-modal-hide="default-modal"
                                ...
                                Criar embalagem de transporte</button>
                        </div>
                    </form>
                </div>
            </div>
...
const adicionar = async () => {
    loading.value = true
    try {
        const response = await useFetch(`${api}/embalagensTransporte/`, {
            method: 'POST',
