              ...
              <tbody class="bg-white dark:bg-gray-800">
                <tr v-for="(encomenda, index) in encomendas">
                  ...
                  <td
                    ...
                    <svg class="w-7 h-7" aria-hidden="true" enable-background="new 0 0 780 500" viewBox="0 0 780 500"
                  ...
                  <td class="p-4 whitespace-nowrap text-center">
                    <NuxtLink :to="`/operador/encomendasCrud/${encomenda.id}`">
    ...
    <div class="flex items-center justify-between pt-3 sm:pt-6">
      <div>
        <button
          ...
          type="button" data-dropdown-toggle="transactions-dropdown">Last 7 days <svg class="w-4 h-4 ml-2" fill="none"
