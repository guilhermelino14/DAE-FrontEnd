            ...
            <div class="col-span-12 md:col-span-11 sm:col-span-10">
                ...
                <div class="items-center justify-between lg:flex">
                    <div class="mb-4 lg:mb-0">
                        <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Adicionar novo produto catalogo</h3>
                    </div>
                </div>
            </div>
        </div>
        <form @submit.prevent="adicionar" class="max-w-sm mx-auto">
            ...
            <div class="mb-5">
                <label for="base-input"
                    ...
                    <textarea  v-model="newProduto.descricao" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Chocolate branco ....." required></textarea>
                </div>
